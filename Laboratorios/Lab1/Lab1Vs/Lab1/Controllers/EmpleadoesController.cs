...
namespace Lab1.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(Laboratorio1Context context)
        {
            _context = context;
        }
        ...
        {
            var laboratorio1Context = _context.Empleados.Include(e => e.IdAreaNavigation).Include(e => e.IdJefeNavigation);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdJefe"] = new SelectList(_context.Empleados, "IdEmpleado", "IdEmpleado");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEmpleado,NombreCompleto,Cedula,Correo,FechaNacimiento,FechaIngreso,IdJefe,IdArea,Foto")] Empleado empleado)
        {
            ...
            ViewData["IdArea"] = new SelectList(_context.Areas, "IdArea", "IdArea", empleado.IdArea);
            ViewData["IdJefe"] = new SelectList(_context.Empleados, "IdEmpleado", "IdEmpleado", empleado.IdJefe);
            return View(empleado);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Laboratorio1Context.Empleados'  is null.");
            }
            var empleado = await _context.Empleados.FindAsync(id);
            if (empleado != null)
            {
